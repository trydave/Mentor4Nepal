...
- 1. [Preferred] For better collaborative writing, install BOX Drive in your Laptop/Computer. Install https://e3.boxcdn.net/box-installers/desktop/releases/win/Box-x64.msi. Create a folder name (see right top corner): Mentor4Nepal_FirstNameLastNameInitial_TDA. eg. Mentor4Nepal_TriDevA_TDA. While creating add my email address: tridevacharya@gmail[dot]com in the "Invite Additonal People" as Editor. Now, this folder is shared with me and I can also edit everything.
