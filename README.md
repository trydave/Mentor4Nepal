...
- 3. For SSO account with Onedrive [Most student email from university are eligible for 1TB Onedrive and free office 365 Student] install or start and login OneDrive https://www.microsoft.com/en-us/microsoft-365/onedrive/download. Go to the OneDrive folder, create a folder: Mentor4Nepal_FullFirstNameInitialLastName_TDA. eg. Mentor4Nepal_TriDevA_TDA. Go to online and share via email address: tridevacharya@gmail[dot]com and tdacharya[at]ucdavis.edu. Now, this drive is shared with me and I can also edit everything.
